...
def handler(event, context):
    ...
    try:
        ...
        mime_type = mimetypes.types_map[body['fileType']]
    ...
    try:
        ...
        presigned_upload_url = s3.generate_presigned_url(ClientMethod='put_object',
    ...
    return {
        'statusCode': 200,
        'body': json.dumps({'uploadUrl': presigned_upload_url, 'downloadUrl': download_url, 'contentType': mime_type,
                            'storageIdentifier': file_key}),
        'headers': {
